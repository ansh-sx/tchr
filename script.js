...
function login() {
    ...
    console.log(`Logging in with teacher name: ${teacherName}`); // Debugging line
    ...
    if (teacherName && teachers[teacherName]) {
        ...
        // Hide the login overlay after successful login
